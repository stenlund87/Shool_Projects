...
local q = require "script/lua/queue"
local breadth = {}

function breadth.init()
    local bfs = {}
    bfs.pathFound = {}
    
 --------------------------------------------------------------------------------------   
 --------------------------------------------------------------------------------------       
    function bfs:TableContainsNode(nodeTable, node)
 ...
 --------------------------------------------------------------------------------------   
    ...
    function bfs:IsTheSameNode(nodeA, nodeB)
        return nodeA == nodeB
    end
 ...
 --------------------------------------------------------------------------------------   
 --------------------------------------------------------------------------------------   
    function bfs:CheckChildren(currentNode, nodeList, visitedList)
        local neighborNodes = {}
...
--------------------------------------------------------------------------------------   
    ...
    function bfs:BreadthFirstSearch(graph, startNode, goalNode)
        local vistedNodes = {}
        local queue = q.init()
        ...
        while queue.size > 0 do
            ...
            local childrenNodes = bfs:CheckChildren(current, graph, visited)
