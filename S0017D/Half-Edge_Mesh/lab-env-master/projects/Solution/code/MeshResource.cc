...
void MeshResource::DrawLines()
{
	for(int i = 0; i < sizeOfBuffer; i+=3)
	{
		glBegin(GL_LINES);

		glVertex3f(*verticeBuffer[indiceBuffer[i]].pos[0],*verticeBuffer[indiceBuffer[i]].pos[1],*verticeBuffer[indiceBuffer[i]].pos[2]);
		glVertex3f(*verticeBuffer[indiceBuffer[i+1]].pos[0],*verticeBuffer[indiceBuffer[i+1]].pos[1],*verticeBuffer[indiceBuffer[i+1]].pos[2]);

		glVertex3f(*verticeBuffer[indiceBuffer[i+1]].pos[0],*verticeBuffer[indiceBuffer[i+1]].pos[1],*verticeBuffer[indiceBuffer[i+1]].pos[2]);
		glVertex3f(*verticeBuffer[indiceBuffer[i+2]].pos[0],*verticeBuffer[indiceBuffer[i+2]].pos[1],*verticeBuffer[indiceBuffer[i+2]].pos[2]);
